...
// @route     POST /api/security-breach-indicators-dashboard/security-breach-indicators-scores
// @access    private
...
// @route     GET /api/security-breach-indicators-dashboard/security-breach-indicators-scores/:id
// @access    Public
...
// @route     GET /api/security-breach-indicators-dashboard/security-breach-indicators-scores
// @access    Public
...
// @route     PATCH /api/security-breach-indicators-dashboard/security-breach-indicators-scores/:id
// @access    private
...
// @route     DELETE /api/security-breach-indicators-dashboard/security-breach-indicators-scores/:id
// @access    private
